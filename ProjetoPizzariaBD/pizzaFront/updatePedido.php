...
<div class="content update">
    ...
    <form action="updatePedido.php?id_contato=<?=$contatos['id_contato']?>" method="post">
        <label for="id_contato">ID</label>
        <label for="nome">Nome</label>  
        <input type="text" name="id_contato" placeholder="" value="<?=$contatos['id_contato']?>" id="id_contato" readonly>
