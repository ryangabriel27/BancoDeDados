        ...
        <tbody>
            <?php foreach ($contacts as $contact) : ?>
                <tr>
                    ...
                    <td class="actions">
                        <a href="updatePedido.php?id_contato=<?= $contact['id_contato'] ?>" class="edit"><i class="fas fa-pen fa-xs"></i></a>
                        <a href="deletePedido.php?id_contato=<?= $contact['id_contato'] ?>" class="trash"><i class="fas fa-trash fa-xs"></i></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
